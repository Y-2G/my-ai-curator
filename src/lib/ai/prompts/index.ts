...
# 評価基準
1. **トピックの関連性** (40%): ユーザーの興味分野との合致度
2. **難易度の適合性** (25%): ユーザーの技術レベルとの適合度
3. **新規性** (20%): ユーザーにとって新しい情報・視点か
4. **実用性** (15%): 実際に役立つ、行動に移せる内容か
...
# 出力例
今週注目の技術記事をキュレーションしました。各記事から最新の技術動向をお楽しみください。
